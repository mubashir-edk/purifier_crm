$(document).ready(function() {
    ...
    // Sort direction
     ...
     function sortTable(column, order) {
         var $tbody = $('#employees_table tbody');
     ...
     $('#searchInput').on('keyup', function() {
         ...
         var totalRows = $('#employees_table tbody tr').length;
         ...
         if (searchText === '') {
             ...
             $('#employees_table tbody tr').filter(function() {
     ...
     function showPage(page, entries) {
         ...
         $('#employees_table tbody tr').hide();
         $('#employees_table tbody tr').slice(start, end).show();
     }
