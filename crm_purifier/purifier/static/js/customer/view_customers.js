$(document).ready(function() {
    ...
    // $('#customers_table thead th:first-child').removeClass('sorting sorting_asc sorting_desc');
    ...
    //         var cell = this.node().getElementsByTagName('th')[0]; // Assuming forloop.counter is in the first column
