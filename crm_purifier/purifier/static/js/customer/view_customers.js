$(document).ready(function() {
    ...
    // Sort direction
     ...
     $('#searchInput').on('keyup', function() {
         ...
         var totalRows = $('#customers_table tbody tr').length;
     ...
     function showPage(page, entries) {
         ...
         $('#customers_table tbody tr').hide();
         $('#customers_table tbody tr').slice(start, end).show();
     }
