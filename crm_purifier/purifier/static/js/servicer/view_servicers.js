$(document).ready(function () {
    ...
    function sortTable(column, order) {
        var $tbody = $('#servicers_table tbody');
    ...
    $('#searchInput').on('keyup', function() {
        ...
        var totalRows = $('#servicers_table tbody tr').length;
        ...
        if (searchText === '') {
            ...
            $('#servicers_table tbody tr').filter(function() {
    ...
    function showPage(page, entries) {
        ...
        $('#servicers_table tbody tr').hide();
        $('#servicers_table tbody tr').slice(start, end).show();
    }
