$(document).ready(function() {
    ...
    // Sort direction
     ...
     function sortTable(column, order) {
         var $tbody = $('#servicework_table tbody');
     ...
     $('#servicework_table').on('click', 'th:not(:first)', function () {
         var columnIndex = $(this).index();
         var columnName = $(this).text().trim().toLowerCase();
         var order = sortDirection[columnName] === 'asc' ? 'desc' : 'asc';

         // Remove sorting indicators from other columns
         $('#servicework_table th').removeClass('sorted-asc sorted-desc');
     ...
     $('#searchInput').on('keyup', function() {
         ...
         var totalRows = $('#servicework_table tbody tr').length;
         ...
         if (searchText === '') {
             ...
             $('#servicework_table tbody tr').filter(function() {
     ...
     function showPage(page, entries) {
         ...
         $('#servicework_table tbody tr').hide();
         $('#servicework_table tbody tr').slice(start, end).show();
     }
